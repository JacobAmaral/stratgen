                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            ...
                                            <div>
                                                <strong>Backtest Engine Redesign:</strong> Re-designed the backtest engine to be much more efficient with data flows, backtesting entry logic, and exit logic.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Combined Strategy Fixes:</strong> Fixed numerous bugs regarding combined long and short strategies.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Incubation Month Setting:</strong> Added incubation month as a configurable setting.
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Z-Score Added:</strong> Added z-score support.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Template Updates:</strong> Updated templates to work with the new settings.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Pyramiding Guard:</strong> Disabled pyramiding when max entries is set to 1.
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Threshold Consistency:</strong> Patched the threshold inconsistency issue.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Optimized Walk-Forward Performance:</strong> Improved walk-forward optimization execution speed and responsiveness for faster iteration on parameter sets.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div>
                                    ...
                                    <ul className="space-y-3">
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Walk-Forward Finalizing Message Fix:</strong> Resolved issue where walk-forward runs could get stuck on a finalizing status message.
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>European Slippage Decimal Fix:</strong> Fixed slippage input parsing so comma decimals (e.g., <code>1,5</code>) work correctly for European locales.
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>Walk-Forward Stop Handling Fix:</strong> Fixed walk-forward tests not ending properly if you click stop.
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-3">
                                            <CheckIcon className="h-5 w-5 text-green-500 flex-shrink-0 mt-0.5" />
                                            <div>
                                                <strong>UI Polish:</strong> Updated the StratGen logo.
                                            </div>
                                        </li>
                                    </ul>
                                </div>
